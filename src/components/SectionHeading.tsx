...
export const SectionHeading: React.FC<SectionHeadingProps> = ({
  ...
  return (
    <Reveal className={`max-w-2xl ${alignment}`}>
      <p className="eyebrow text-accent-blue flex items-center gap-2">
        <span className="inline-block h-px w-8 bg-accent-blue/60" />
        {eyebrow}
        {align === 'center' && <span className="inline-block h-px w-8 bg-accent-blue/60" />}
      </p>
